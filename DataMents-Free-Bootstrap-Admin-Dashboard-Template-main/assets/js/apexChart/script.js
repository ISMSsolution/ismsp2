...
function d2c_doughnutChart2() {
    ...
    var chart = new ApexCharts(document.querySelector("#doughnut-Chart2"), options);
    chart.render();
}
d2c_doughnutChart2();

// Doughnut Chart3
function d2c_doughnutChart3() {
    var options = {
        series: [80, 20],
        chart: {
            type: 'donut',
    ...
    var chart = new ApexCharts(document.querySelector("#doughnut-Chart3"), options);
    chart.render();
}
d2c_doughnutChart3();
